error id: file://<WORKSPACE>/laboratorio/src/main/scala/Main.scala:
file://<WORKSPACE>/laboratorio/src/main/scala/Main.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -subscripcion.
	 -scala/Predef.subscripcion.
offset: 2221
uri: file://<WORKSPACE>/laboratorio/src/main/scala/Main.scala
text:
```scala
...
object Main {
  ...
  val sc = spark.sparkContext
    ...
    val postsFailed = subscrip@@cion.count() - downloadResults.count()
  ...
  val entidades = downloadResults.flatMap()
