error id: file://<WORKSPACE>/laboratorio/src/main/scala/Main.scala:flatMap.
file://<WORKSPACE>/laboratorio/src/main/scala/Main.scala
empty definition using pc, found symbol in pc: flatMap.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -downloadResults/flatMap.
	 -downloadResults/flatMap#
	 -downloadResults/flatMap().
	 -scala/Predef.downloadResults.flatMap.
	 -scala/Predef.downloadResults.flatMap#
	 -scala/Predef.downloadResults.flatMap().
offset: 3960
...
object Main {
  ...
  val entidades = downloadResults.f@@latMap( post =>{
